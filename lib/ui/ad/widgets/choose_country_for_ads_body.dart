// // ignore_for_file: unused_field, unused_element, unused_local_variable, deprecated_member_use, unnecessary_statements, non_constant_identifier_names, unnecessary_brace_in_string_interps
...
// ///do not save
// class ChooseCountryForAdsBody extends StatefulWidget {
//   final bool ChooseCityFromFilter;
//   const ChooseCountryForAdsBody({Key? key, required this.ChooseCityFromFilter})
//       : super(key: key);

//   @override
//   State<ChooseCountryForAdsBody> createState() =>
//       _ChooseCountryForAdsBodyState();
// }

// class _ChooseCountryForAdsBodyState extends State<ChooseCountryForAdsBody> {
...
//           //         .setCountryId(_allCountries[index]["id"] ?? 0)
//           //     : addAddsSharedPreferences
//           //         .setCountryId(_searchedResult[index]["id"] ?? 0);

//           // print(addAddsSharedPreferences.getCountryId());
//           // _adsProvider!.setCityId(_allCountries[index]["id"]);
//           // _adsProvider!.setCityName(_allCountries[index]["text"]);
...
//         });
//         if (widget.ChooseCityFromFilter) {
//           Navigator.pop(context);
//         } else
//           Navigator.push(
//               context,
//               MaterialPageRoute(
//                   builder: (context) => ChooseAreaForAds(
//                         chooseAreaFromFilter: widget.ChooseCityFromFilter,
//                       )));
//       },
//       child: Column(
...
//                     ? addAddsSharedPreferences.getCountryId() ==
//                             _allCountries[index]["id"]
//                         ? 1
//                         : 0
//                     : addAddsSharedPreferences.getCountryId() ==
...
//                     .translate("searching_in_cities"), //todo
//                 hintStyle: TextStyle(
...
//     final response = await http.get(
//         Uri.parse(
//           "${Urls.GET_ALL_CITIES_URL}${searchPage}&name=${value}",
//         ),
//         headers: <String, String>{
//           'Accept': 'application/json',
//           "Accept-Language": UserData.getUSerLang(),
...
//       final response = await http.get(
//           Uri.parse(
//             "${Urls.GET_ALL_CITIES_URL}${searchPage}&name=${searchContent}",
//           ),
//           headers: <String, String>{
//             'Accept': 'application/json',
//             "Accept-Language": UserData.getUSerLang(),

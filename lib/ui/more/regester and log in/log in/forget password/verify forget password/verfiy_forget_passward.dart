...
class VerfyForgetPasswardBottomSheet extends StatefulWidget {
  const VerfyForgetPasswardBottomSheet({
    Key? key,
  }) : super(key: key);

  @override
  State<VerfyForgetPasswardBottomSheet> createState() =>
      _VerfyForgetPasswardBottomSheetState();
}

class _VerfyForgetPasswardBottomSheetState
    extends State<VerfyForgetPasswardBottomSheet> {
                      ...
                      child: PinCodeTextField(
                          ...
                          onCompleted: (String value) {
                            ...
                            final provider = Provider.of<FirebaseAutProvider>(
                                context,
                                listen: false);
                            provider.sendCodeForForgetPasswardToFirebase(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                SmallText(
                                  ...
                                  // size: _height / 62.46153846153846,
                                  color: textGrayColor,
                                  typeOfFontWieght: 0,
                                ),
                                SmallText(

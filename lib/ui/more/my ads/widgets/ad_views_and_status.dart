...
class AdViewsAndStatus extends StatefulWidget {
  int ad_Id;
  int adView;
  var statusNumber;
  AdViewsAndStatus({
  ...
  @override
  State<AdViewsAndStatus> createState() => _AdViewsAndStatusState();
}

class _AdViewsAndStatusState extends State<AdViewsAndStatus> {
  double? _height;
  double? _width;

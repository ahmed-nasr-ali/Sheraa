...
class SpecialAdScreen extends StatefulWidget {
  const SpecialAdScreen({Key? key}) : super(key: key);

  @override
  State<SpecialAdScreen> createState() => _SpecialAdScreenState();
}

class _SpecialAdScreenState extends State<SpecialAdScreen> {
  @override
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: SmallText(
            ...
            typeOfFontWieght: 1,
            text: AppLocalizations.of(context)!.translate("ad") + " "+

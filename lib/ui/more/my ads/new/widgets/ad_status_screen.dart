...
class AdStatusScreen extends StatefulWidget {
  const AdStatusScreen({Key? key}) : super(key: key);
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: SmallText(
              ...
              typeOfFontWieght: 1,
              text: AppLocalizations.of(context)!.translate("Ad status")),
        ),
        body: ListView(
          children: [
            Column(
                ...
                Container(
                  ...
                  child: SmallText(
                      ...
                      text: AppLocalizations.of(context)!.translate(
                        "The ad quality ratio is calculated and the quality is increased by adding images and more details to the ad",
                      )),
                )
              ],
            )

...
class EarnPointQuestionScreen extends StatefulWidget {
  const EarnPointQuestionScreen({Key? key}) : super(key: key);

  @override
  State<EarnPointQuestionScreen> createState() =>
      _EarnPointQuestionScreenState();
}

class _EarnPointQuestionScreenState extends State<EarnPointQuestionScreen> {
  @override
          ...
          children: [
            Column(
              ...
              children: [
                ...
                BigText(
                  text:
                      AppLocalizations.of(context)!.translate("earned_points"),
                  size: _height / 58, //14
                  typeOfFontWieght: 1,
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: SmallText(
                      ...
                      text: AppLocalizations.of(context)!.translate(
                        "It is the sum of points earned",
                      )),
                )
              ],
            )

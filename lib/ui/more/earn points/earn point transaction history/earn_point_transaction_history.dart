...
class EarnPointTransactionHistory extends StatefulWidget {
  const EarnPointTransactionHistory({Key? key}) : super(key: key);

  @override
  State<EarnPointTransactionHistory> createState() =>
      _EarnPointTransactionHistoryState();
}

class _EarnPointTransactionHistoryState
    extends State<EarnPointTransactionHistory> {
  @override
              ...
              Container(
                ...
                child: SmallText(
                  ...
                  text: AppLocalizations.of(context)!.translate(
                    "Is the process of earning points in a purchase",
                  ),
                ),
              )
            ],
